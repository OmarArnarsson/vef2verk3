INSERT INTO applications (name,email,phone,text,job) 
VALUES ('Jón Jónsson','jon@example.org',1231231,'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut bibendum eleifend odio, eu laoreet sapien sollicitudin quis.','forritari');
INSERT INTO applications (name,email,phone,text,job,processed) 
VALUES ('Guðmundur Guðmundsson','gummi@example.org',1233211,'Nam a sapien tellus. Class aptent taciti sociosqu ad litora torquent per conubia nostra, per inceptos himenaeos. Phasellus tincidunt ante nisl, eu placerat arcu porttitor mollis. Duis porttitor dolor vitae aliquet sollicitudin. Etiam scelerisque, lorem eu varius eleifend, elit diam facilisis leo, sit amet volutpat est enim eu tortor. Mauris non tortor eget nibh fermentum maximus vel sit amet ante. Vestibulum condimentum facilisis nisl eget interdum. Donec vel cursus purus.','forritari',true);
INSERT INTO applications (name,email,phone,text,job) 
VALUES ('Anna Önnudóttir','anna@example.org',3333333,'Sed in sem sagittis, fringilla justo eget, vulputate nunc. Cras pharetra faucibus blandit. Sed non porta ligula, non efficitur dolor.','forritari');
INSERT INTO applications (name,email,phone,text,job) 
VALUES ('Guðmunda Guðmundsdóttir','gudmunda@example.org',1111111,'Aenean a nibh a enim cursus bibendum. Donec dictum velit in odio feugiat imperdiet. Sed blandit, justo vitae lacinia efficitur, tortor ante ultrices orci, nec placerat dui purus ac augue. Nullam aliquet purus sit amet erat laoreet, nec consequat augue suscipit. Curabitur rutrum pretium erat sed pellentesque. Proin ligula massa, varius id tristique in, varius id elit. Sed congue volutpat fringilla.','hönnuður');
INSERT INTO applications (name,email,phone,text,job) 
...
VALUES ('Admin','admin@example.org','admin','$2y$11$STtmK4IAZ8NBG2.L/AR66ud8G29SftFuLM3JS39NbgpJAV.Qo6wa6',true);
INSERT INTO users (name,email,username,password)
VALUES ('nn','nn@example.org','nn','$2y$11$sWhT9CsnuH.94yOne.htqOWYKcXeoX2ksZnJwCrAwrsjU7LxSDXLK');
